...
const guiLibraryFolder = pathUtil.join(__dirname, '../src/lib/libraries');
...
const downloadAsset = async (asset) => {
    ...
    const assetPath = pathUtil.join(libraryFiles, md5ext);
    ...
    await writeFile(assetPath, uncompressed);
};
